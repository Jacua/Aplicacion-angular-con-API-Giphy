...
export interface SearhGIFResponse {
    data:       Gif[];
...
export class Convert {
    public static toSearhGIFResponse(json: string): SearhGIFResponse {
        return cast(JSON.parse(json), r("SearhGIFResponse"));
    }

    public static searhGIFResponseToJson(value: SearhGIFResponse): string {
        return JSON.stringify(uncast(value, r("SearhGIFResponse")), null, 2);
    }
}
